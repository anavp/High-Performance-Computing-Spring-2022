...
//
  for ( i = 0; i < 10; i++ ) // It seems to me that the simplest way to fix all of the problems that show up later on is to just properly initialize everything. As such, I changed the loop so as to iterate over all of the elements of the array x and initialize the same.
  {
    x[i] = i;
  }
//
